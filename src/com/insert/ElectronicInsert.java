...
/**
 * Servlet implementation class ElectronicInsert
 */
@MultipartConfig(maxFileSize = 16177215)
@WebServlet("/ElectronicInsert")
public class ElectronicInsert extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ElectronicInsert() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("eletronic inset");
		 ...
		 boolean isSucess = itemsDButill.insertItem(ItemName, Title, Description,Price, inputStream1, inputStream2, inputStream3, sid);
