...
/**
 * Servlet implementation class ToyInsert
 */
@MultipartConfig(maxFileSize = 16177215)
@WebServlet("/ToyInsert")
public class ToyInsert extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("eletronic inset");
		 ...
		 boolean isSucess = ToysDBUtill.insertItem(ItemName, Title, Description,Price, inputStream1, inputStream2, inputStream3, sid);
